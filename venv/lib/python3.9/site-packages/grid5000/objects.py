...
class Job(RESTObject, RefreshMixin, ObjectDeleteMixin):
    ...
    _managers = (
        ...
        ("walltime_change", "WallTimeManager"),
    )
...
class WallTimeManager(GetWithoutIdMixin, CreateMixin, RESTManager):
    _path = "/sites/%(site)s/jobs/%(jobid)s/walltime"
    _obj_cls = WallTime
    _from_parent_attrs = {"site": "site", "jobid": "uid"}
